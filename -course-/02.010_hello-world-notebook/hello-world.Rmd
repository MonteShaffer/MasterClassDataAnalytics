...
microbenchmark::microbenchmark(pracma::primes(22) , prime.pracmaPrimes(22), prime.pracmaPrimes(22, first=TRUE) )
```
...
```{r}
library(microbenchmark);
microbenchmark::microbenchmark(strPadLeft( decbin(57), 8) , strPadLeft( decbin(57), 8, method="base"), strPadLeft( decbin(57), 8, method="Adljblkjadlk"))
```
...
# setwd("C:\\_git_\\github\\MonteShaffer\\MasterClassDataAnalytics\\-course-\\02.020_hello-world-notebook\\");
# Rcpp.package.skeleton("test", cpp_files = "C:\\_git_\\github\\MonteShaffer\\MasterClassDataAnalytics\\-course-\\02.020_hello-world-notebook\\multiply.cpp")
```
